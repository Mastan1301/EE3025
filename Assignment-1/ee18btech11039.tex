...
\begin{lstlisting}
https://github.com/Mastan1301/EE3025/tree/main/Assignment-1/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/Mastan1301/EE3025/tree/main/Assignment-1
\end{lstlisting}
...
\end{align}    
From the coefficients b,a and from \eqref{eq:Hz_equation}, we obtain $H(K)$.
\\
The np.fft function is used to compute DFT $X(K)$ from $x(n)$.\\
To obtain $y(n)$, we first compute $Y(K)$ from, 
\begin{align}
    Y\brak{K} = H\brak{K}X\brak{K}
\end{align}
Then, we use ifft function to compute $y(n)$ from $Y(K)$ and store the result in a wav file.
\\
...
Below is the soundfile constructed using own routine-
\begin{lstlisting}
codes/Sound_With_ReducedNoise_1.wav
\end{lstlisting}

The soundfile obtained using library function - 
\begin{lstlisting}
codes/Sound_With_ReducedNoise_2.wav
\end{lstlisting}
