...
\begin{figure}
\label{fig1}
\includegraphics[width = 15cm]{figs/iir/analog_lp_epsilons.eps}
...
\begin{figure}
\label{fig2}
\includegraphics[width = 15cm]{figs/iir/analog_lp_cheb.eps}
...
\begin{figure}
\label{fig3}
\includegraphics[width = 15cm]{figs/iir/analog_bp.eps}
...
\begin{figure}
\label{fig4}
\includegraphics[width = 15cm]{figs/iir/digital_bp.eps}
